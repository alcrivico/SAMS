    ...
    namespace SAMS.UI.Views
    {
        ...
        public partial class EditarProductoView : Window
        {
            ...
            /*
            private void EditarProductoInventarioDTO()
            {
                try
                {
                    ...
                    var editarProductoDTO = new EditarProductoInventarioDTO
                    {
                        ...
                        cantidadBodega = int.Parse(TextBox_CantidadBodega.Text.Trim()),
                        cantidadExhibicion = int.Parse(TextBox_CantidadExhibicion.Text.Trim()),
                        ...
                        //esPerecedero = CheckBox_EsPerecedero.IsChecked ?? false,
                        //esDevolvible = CheckBox_EsDevolvible.IsChecked ?? false
                    };

                    // Aquí puedes enviar el DTO al DAO para persistir los cambios en la base de datos
                    //ProductoInventarioDAO productoInventarioDAO = new ProductoInventarioDAO();
                    //bool resultado = productoInventarioDAO.EditarProductoInventario(editarProductoDTO);
