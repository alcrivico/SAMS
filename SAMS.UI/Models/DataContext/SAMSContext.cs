...
public class SAMSContext : DbContext
{
    ...
    public DbSet<DetalleVentaDTO> V_DetalleVenta { get; set; }
    public DbSet<VentaDTO> V_Venta { get; set; }
    ...
    public DbSet<CategoriasDTO> V_CategoriasActivas { get; set; }
    public DbSet<MermaDTO> V_Mermas { get; set; }
    public DbSet<ProductoInventarioMermaDTO> V_ProductosDisponiblesEnInventario {  get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PedidosDTO>()
            .HasNoKey()
            .ToView("V_Pedidos");
        modelBuilder.Entity<DetalleVentaDTO>()
            .HasNoKey()
            .ToView("V_DetalleVenta");
        ...
        modelBuilder.Entity<CategoriaDTO>()
            .HasNoKey()
            .ToView("V_Categorias");
        modelBuilder.Entity<ProductoPorDetalleDTO>()
            .HasNoKey()
            .ToView("V_ProductoPorDetalle");
        modelBuilder.Entity<MermaDTO>()
            .HasNoKey()
            .ToView("V_Mermas");
        modelBuilder.Entity<CategoriasDTO>()
            .HasNoKey()
            .ToView("V_CategoriasActivas");
        modelBuilder.Entity<ProductoInventarioMermaDTO>()
            .HasNoKey()
            .ToView("V_ProductosDisponiblesEnInventario");
